...
def data_prepare(data="celeba", mode="ndarry"):
    ...
    if data == "celeba":
        files = utils.get_file_names("/mnt/data0/fuwenjie/MIA/MIA-Gen/VAEs/data/celeba64/total")
    elif data == "tinyin":
        files = utils.get_file_names("/mnt/data0/fuwenjie/MIA/MIA-Gen/VAEs/data/Tiny-IN")
